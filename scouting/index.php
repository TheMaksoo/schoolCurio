                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.html"><img src="images/logo.png" alt="#" style="height: 150px";/></a>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="juice.html">Order Merch</a>
                              </li>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <div class="test_box">
                     <div class="text-bg">
                        <h1><span> Welcome to</span> <br>Scouting</h1>
                        <p>Scouting raamsdonksveer</p>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="banner_img">
                                          <figure><img src="images/banner_img.png" alt="#" style="height: 400px"></figure>
                                       </div>
                                    </div>
                                 </div>
                              </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>onze Merch</h2>
                     <p>zorgt dat we blijven bestaan.</p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="our_main_box">
                     ...
                     <div class="our_text">
                        <h4>$<strong class="yellow">39,99</strong></h4>
                        <h3>Hoodie</h3>
                        <p>cool shirt</p>
               ...
               <div class="col-md-4">
                  <div class="our_main_box">
                     ...
                     <div class="our_text">
                        <h4>$<strong class="yellow">29,99</strong></h4>
                        <h3>Shirt</h3>
                        <p>soft cotton</p>
                        <a class="read_more" href="#">Order Now</a>
                     </div>
               ...
               <div class="col-md-4 ">
                  <div class="our_main_box">
                     ...
                     <div class="our_text">
                        <h4>$<strong class="yellow">55</strong></h4>
                        <h3>Cargo pants</h3>
               ...
               <div class="col-md-4 margin_top">
                  <div class="our_main_box">
                     ...
                     <div class="our_text">
                        <h4>$<strong class="yellow">24,99</strong></h4>
                        <h3>cargo short</h3>
                        <p>Same as pants but short</p>
                        <a class="read_more" href="#">Order Now</a>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="our_main_box">
                     ...
                     <div class="our_text">
                        <h4>$<strong class="yellow">74,99</strong></h4>
                        <h3>Scouting schoenen</h3>
                        <p>Cool stylish boots</p>
                        <a class="read_more" href="#">Order Now</a>
                     </div>
                  </div>
               </div>
         ...
         <div class="footer" style="margin-top: 300px" >
               ...
               <div class="row">
                  ...
                  <div class="col-md-10 offset-md-1">
                     <ul class="location_icon">
                        ...
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a>scoutingrdv@gmail.com</li>
                     </ul>
                  </div>
               </div>
            </div>
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>Copyright 2019 All Right Reserved By TheMaksoo</a></p>
                     </div>
                  </div>
               </div>
            </div>
